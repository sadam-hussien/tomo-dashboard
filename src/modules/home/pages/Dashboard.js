...
import { apiGetDashboard } from "../server";

import { useFetch } from "hooks";

import { months } from "helpers/global";
...
const categories = [
  {
    ...
    text: "اجمالي المبيعات بدون الضريبة",
    number: "totalSoldWithoutTax",
    color: "#C6002E",
  },
  {
    id: 2,
    ...
    text: "اجمالي مشتركين التدريب",
    number: "allUserSubscribe",
    color: "#E45F26",
  },
  {
    id: 3,
    ...
    text: "اجمالي المشتركين في تومو",
    number: "allUserInTomo",
    color: "#01535A",
  },
];
                  ...
                  <Col key={item.id}>
                    <div className="boxed category-item">
                      ...
                      <div className="d-flex justify-content-end mb-md category-item-header-number">
                        <span>{dashboardData.dash_counts[item.number]}</span>
                      </div>
            ...
            <Col lg={7} xl={8}>
              <div className="boxed mb-xl category-item category-item-hero d-flex align-items-center justify-content-between">
                ...
                <div>
                  ...
                  <div className="d-flex justify-content-end mb-md category-item-header-number">
                    <span>{dashboardData.dash_counts.activeSubscribe}</span>
                  </div>
              ...
              <div className="boxed clients">
                ...
                <div className="clients-body">
                  <Row xs={1} sm={2} md={3} xl={5} className="g-4">
                    {dashboardData.dash_counts.users.map((item, index) => (
                      <Col key={item.id}>
