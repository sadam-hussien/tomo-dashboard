...
export default function Add({ handleClose }) {
  ...
  const mealsTitles = ["الوجبة الاولي", "الوجبة الثانية"];
          ...
          <Form>
            <SelectBox
              item={{
                name: "program",
                id: "program",
                options: [{ label: "غذائي", value: "غذائي" },{ label: "رياضي", value: "رياضي" }],
              }}
              placeholder={t("برنامج غذائي")}
            />
            <InputWithIcon
              type="text"
              name="program"
